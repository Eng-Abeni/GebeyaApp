...
import com.kotlinapp.gebeya.view.DetailProductActivity
import com.kotlinapp.gebeya.view.FavouriteActivity
...
class FavouriteAdapter : RecyclerView.Adapter<FavouriteAdapter.ItemHolder> {
    ...
    override fun onBindViewHolder(holder: ItemHolder, position: Int) {
        ...
        holder.textView_fav_price.text = decimalFormat.format(Double.valueOf(price)) + " ብር"
