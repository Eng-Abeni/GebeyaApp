...
import com.kotlinapp.gebeya.model.*
...
class HomeActivity : AppCompatActivity() {
    ...
    private fun getLoginInfo() {
        ...
        if (type.equals("normal")) {
            ...
            loadUserProfile(Server.getUserInfo, phone.toString())
            // Get user id
            ...
            var stringRequest = object : StringRequest(Method.POST, Server.getUserId, object : Response.Listener<String>{
                ...
                override fun getParams(): MutableMap<String, String> {
                    ...
                    hashMap.put("phoneNumber", phone.toString())
                    return hashMap
                }
            }
            ...
            getUserIdOfSocial(Server.getUserId2, id.toString())
        }
