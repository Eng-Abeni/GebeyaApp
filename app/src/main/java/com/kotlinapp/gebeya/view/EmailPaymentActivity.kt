...
import com.kotlinapp.gebeya.model.Server
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        button_agree.setOnClickListener {
            ...
            handler.postDelayed(Runnable {
                ...
                Toast.makeText(this@EmailPaymentActivity, "Mail has been sent.", Toast.LENGTH_SHORT).show()
            }, 2000)
                                ...
                                if (response != null) {
                                    ...
                                    for (i in 0 until jsonArray.length()) {
                                        ...
                                        var textBody = "<!DOCTYPE html>\n" +
                                                ...
                                                "\t<a href=\"https://newwgenn.com/user/confirm.php?idOrder=" +
                                                ""+idOrder+"&idUser="+idUser+"\">Confirm</a>\n" +
                                                "</body>\n" +
                                                "</html>"

                                        var sender = GMailSender("GebeyaKotlin@gmail.com", "@Gebeya1231")
                                        sender.sendMail("[Gebeya App] Mail confirm order", textBody,"saremtadele1@gmail.com",
                                            email)
                                        if (sender != null) {
                                            Toast.makeText(this@EmailPaymentActivity, "Mail has been sent.", Toast.LENGTH_SHORT).show()
                                        }
